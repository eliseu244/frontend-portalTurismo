...
const Footer = () => {
    return (
        <>
        <footer className="w-full bg-gradient-to-r from-blue-700 to-amber-50 text-cyan-300 py-2 px-2 shadow-lg mt-auto">
            <div className="w-full mx-auto flex flex-col md:flex-row justify-between items-center">
                <div className="text-center md:text-left mb-4 md:mb-0">
                    <p className="text-sm text-amber-200"> Nova serra verde. Todos os direitos reservados</p>
                </div>
