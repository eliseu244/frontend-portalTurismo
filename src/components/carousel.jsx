...
import igreja from "../assets/imagens/igreja-da-pampulha.jpg"
import Mirante from "../assets/imagens/MirantedasMangabeiras.png"
import parque from "../assets/imagens/parque-guanabara-bh.png"
import praça from "../assets/imagens/praça.da.liberdade.jpg"
import praca from "../assets/imagens/praca-do-papa-.png"
import Zoológico from "../assets/imagens/Zoológico.jpg" 

// Array de objetos com dados dos pontos turísticos (imagem, título e descrição)
const tourist_places = [
    { import: igreja, title: "igreja-da-pampulha", description: " Ponto turistico religioso" },
    { import: Mirante, title: "MirantedasMangabeiras", description: " otimo lugarpara ver a cidade" },
    { import: parque, title: "parque-guanabara-bh", description: "otimo lugar para se divertir" },
    { import: praça, title: "praça.da.liberdade", description: "otimo lugar para passear" },
    { import: praca, title: "praca-do-papa-", description: " otimo lugar para ir para igreja" },
    { import: Zoológico, title: "Zoológico", description: " otimo lugar para ver os animais" },
] 
    ...
    return (
        <>
            ...
            <div className=" relative z-10 ">
                ...
                <h1 className=" text-3xl font-bold text-center mt-32 text-amber-300 drop-shadow-lg">
