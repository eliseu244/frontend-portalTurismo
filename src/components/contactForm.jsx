...
import bg from "../assets/imagens/parque-guanabara-bh.png"
const ContactForm = () => {
        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div> {/* campo para entrada de nome */}
                    ...
                    required
                    className="w-full border border-b-cyan-700 p-2 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 text-sm sm:text-base"
